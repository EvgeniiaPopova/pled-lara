$(document).ready(function(){
	...
	=================================*/
	if(!isMobile.any()){
		$(".footer-social .fa-facebook-official").hover(function(){$("#main-footer").toggleClass("footer-facebook-hovered")});
		$(".footer-social .fa-vk").hover(function(){$("#main-footer").toggleClass("footer-twitter-hovered")});
		$(".footer-social .fa-odnoklassniki-square").hover(function(){$("#main-footer").toggleClass("footer-linkedin-hovered")});
		$(".footer-social .fa-instagram").hover(function(){$("#main-footer").toggleClass("footer-instagram-hovered")});
	}});
